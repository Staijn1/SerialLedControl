...
class HomeboundProgram {
    ...
    run() {
        ...
        background(0)
        fill(255);
        triangle(width / 2 - 75, 200, width / 2 - 325, height - 200, width / 2 - 265, height - 200);
        triangle(width / 2 + 75, 200, width / 2 + 325, height - 200, width / 2 + 265, height - 200);
        fill(0, 100, 100)
        quad(width / 2 + 265, height - 200, width / 2 + 275, height - 200, width / 2 + 275, height - 190, width / 2 + 265, height - 190)
    }
}
...
class MainProgram {
    ...
    constructor(amount, percentage) {
        ...
        this.homeBoundProgram = new HomeboundProgram(this.fftProgram);
        ...
        this.modeRadioButton.option('Homebound', this.HOMEBOUND_PROGRAM);
    ...
    run() {
        ...
        switch (this.programStatus) {
            ...
            case this.HOMEBOUND_PROGRAM: {
                this.sendProgram.setValue(this.fftProgram.getBass()).run();
                this.homeBoundProgram.run();
                break;
            }
            default:
                throw 'Unknown state!'
